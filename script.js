...
function addVocabulary2(randomNumber1, randomNumber2) {
    ...
    newEntry.innerHTML = `<button class="custom-buttontext" onclick="speakText('${Englishvoca[randomNumber1]}')">${Englishvoca[randomNumber1]}</button> <button class="custom-buttontext2" onclick="speakText2('${KoreanVoca[randomNumber1]}')">${KoreanVoca[randomNumber1]}</button>`;
...
function resetGame() {
    ...
    // Optionally clear the vocabulary lists
    // document.getElementById("english").innerHTML = "English";
    // document.getElementById("korean").innerHTML = "Korean";
    var wordList = document.getElementById("word-list");

    // Xóa tất cả các thành phần con
    wordList.innerHTML = "";
...
function addVocabulary(wordEng, wordKor) {
    document.getElementById("english").innerHTML += "<p>" + wordEng + "</p>";
    document.getElementById("korean").innerHTML += "<p>" + wordKor + "</p>";
}
